...
class CLIPVisionEncoder(nn.Module):
    ...
    def __init__(self, vision_encoder, args, delay_load=False):
        ...
        if not delay_load:
            ...
            self.cfg_only = CLIPVisionConfig.from_pretrained("/root/.cache/huggingface/hub/DAMO-NLP-SG/SigLIP-NaViT")
    ...
    def load_model(self):
        ...
        self.image_processor = CLIPImageProcessor.from_pretrained("/root/.cache/huggingface/hub/DAMO-NLP-SG/SigLIP-NaViT")

        self.vision_encoder = CLIPVisionModel.from_pretrained("/root/.cache/huggingface/hub/DAMO-NLP-SG/SigLIP-NaViT",
...
class SiglipVisionEncoder(nn.Module):
    ...
    def load_model(self):
        ...
        self.image_processor = SiglipImageProcessor.from_pretrained("/root/.cache/huggingface/hub/DAMO-NLP-SG/SigLIP-NaViT")

        self.vision_encoder = SiglipVisionModel.from_pretrained("/root/.cache/huggingface/hub/DAMO-NLP-SG/SigLIP-NaViT",
                                                              attn_implementation=self.attn_implementation)
...
class Videollama3VisionEncoder(nn.Module):
    ...
    def __init__(self, vision_encoder, args, delay_load=False):
        ...
        if not delay_load:
            ...
            self.cfg_only = Videollama3VisionEncoderConfig.from_pretrained("/root/.cache/huggingface/hub/DAMO-NLP-SG/SigLIP-NaViT")
    def load_model(self, args):
        ...
        print(self.vision_encoder_name)
        self.image_processor = Videollama3ImageProcessor.from_pretrained("/root/.cache/huggingface/hub/DAMO-NLP-SG/SigLIP-NaViT")
        ...
        self.vision_encoder = Videollama3VisionEncoderModel.from_pretrained(
            "/root/.cache/huggingface/hub/DAMO-NLP-SG/SigLIP-NaViT",
