#!/bin/bash
MODEL_PATH=${1:-"/home/disk/VideoLLaMA3/work_dirs/videollama3_qwen2.5_7b/stage_4-AAAI"} #/home/disk/VideoLLaMA3/work_dirs/videollama3_qwen2.5_7b/stage_4-yuanxian341
BENCHMARKS=${2:-"videomme"} # perception_test videomme
...
SAVE_DIR=/home/disk/data_root/videollama-7b-aaai
DATA_ROOT=/home/disk/data_root
