...
torchrun --nnodes $WORLD_SIZE \
    ...
    --model_path /home/disk/VideoLLaMA3/weight/videollama3_7b_local \
    --vision_encoder DAMO-NLP-SG/SigLIP-NaViT \
    --mm_projector_type mlp2x_gelu \
    --data_path /home/disk/underwater-dataset/Train/output_clean.jsonl \
    ...
    --tf32 True \
    --fp16 False \
    --output_dir ${OUTP_DIR}/${WANDB_PROJECT}/${RUN_NAME}-ceshi1 \
    --num_train_epochs 1 \
